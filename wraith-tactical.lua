...
local i18n = {
    data = {
        pleaseUpdateMoonloader = {
            ...
            ru =
            "wraith-tactical - у вас слишком старый moonloader. Обновить: https://www.blast.hk/moonloader/download.php"
        },
        welcomeMessage = {
            ...
            ru = "{348cb2}wraith-tactical v" .. thisScript().version ..
                " активирован! {7ef3fa}/wraith-tactical - menu!"
        },
        ...
        radioDisabledWarning = {
            ...
            ru =
            "{348cb2}wraith-tactical не может воспроизводить звуки. {7ef3fa}Увеличьте громкость радио в настройках и перезайдите в игру."
        },
        desc = {
            en = "About the script",
        ...
        description = {
            ...
            ru =
            "wraith-tactical - это чит, который переносит некоторые способности персонажа Wraith из игры Apex Legends в SA:MP.\n\nАвтор: qrlk. Скрипт написан специально для сообщества BLASTHACK (SC23)."
        },

        moreAboutScript = {
            en = "More about wraith-tactical",
            ru = "Подробнее о wraith-tactical"
        },
